...
class Resumo(Resource):
    ...
    def pass_by_string_values_categoria(dict_categoria):
        dict_categoria['Alimentação'] = '{:.2f}'.format(
            dict_categoria['Alimentação']
        ).replace('.', ',')
        dict_categoria['Saúde'] = '{:.2f}'.format(
            dict_categoria['Saúde']
        ).replace('.', ',')
        ...
        dict_categoria['Educação'] = '{:.2f}'.format(
            dict_categoria['Educação']
        ).replace('.', ',')
